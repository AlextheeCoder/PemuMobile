...
const RootLayout = () => {
  ...
  return (
    ...
    <Stack>
      ...
      <Stack.Screen name='farmer/create-harvest' options={{headerShown: true, headerTitle:"Create Harvest"}} />
      <Stack.Screen name='farmer/create-payment' options={{headerShown: true, headerTitle:"Create Payment"}} />
